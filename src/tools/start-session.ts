...
import { PiTool, StartSessionArgs } from "../types.js";

export const startSessionTool: PiTool<StartSessionArgs> = {
  name: "start_session",
  description:
    "Opens a Computer-Use Agent (CUA) desktop session. REQUIRED before using any desktop interaction tools (screenshot, mouse, keyboard, drag, record). Captures the initial desktop state, returns operational instructions on how to use all CUA tools and DaVinci Resolve shortcuts, and unlocks desktop control.",
  parameters: {
    type: "object",
    properties: {
      purpose: {
  ...
  execute: async (args: StartSessionArgs = {}) => {
