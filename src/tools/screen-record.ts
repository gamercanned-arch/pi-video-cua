...
export const screenRecordTool: PiTool<ScreenRecordArgs> = {
  name: "screen_record",
  description:
    "[Requires active CUA session started via 'start_session'] Records the primary screen and system audio simultaneously for a specified duration in seconds using FFmpeg. Returns the resulting MP4 video file path and a screenshot. Useful for watching and listening to DaVinci Resolve timeline playback.",
  parameters: {
    type: "object",
    properties: {
      duration: {
