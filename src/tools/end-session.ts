...
import { PiTool, EndSessionArgs } from "../types.js";

export const endSessionTool: PiTool<EndSessionArgs> = {
  name: "end_session",
  description:
    "Concludes an active Computer-Use Agent (CUA) desktop session. Releases held resources, safely locks all desktop interaction tools, and terminates the background helper process.",
  parameters: {
    type: "object",
    properties: {
      summary: {
  ...
  execute: async (args: EndSessionArgs = {}) => {
