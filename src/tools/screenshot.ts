...
import { PiTool, ScreenshotArgs } from "../types.js";

export const screenshotTool: PiTool<ScreenshotArgs> = {
  name: "screenshot",
  description:
    "[Requires active CUA session started via 'start_session'] Takes a screenshot of the entire primary display and returns it with normalized coordinate metadata (0.0 to 1.0) and resolution information.",
  parameters: {
    type: "object",
    properties: {},
  },
  execute: async (args: ScreenshotArgs) => {
    ...
    const safeArgs: ScreenshotArgs = args && typeof args === "object" ? args : {};
    try {
