...
export class SessionManager {
  ...
  private purpose: string | null = null;
   ...
   */
  public getSessionInfo(): { sessionId: string; startedAt: number; durationSeconds: number; purpose?: string } | null {
   ...
   */
  public start(purpose?: string): { sessionId: string; isNew: boolean } {
   ...
   */
  public end(summary?: string): { wasActive: boolean; durationSeconds: number; summary?: string } {
    if (!this.active) {
