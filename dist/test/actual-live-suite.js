...
import { HelperClient, screenshotTool, moveMouseTool, clickTool, dragTool, waitTool, scrollTool, screenRecordTool, pressKeyTool, typeTextTool, } from "../src/index.js";
...
async function runLiveActualTestSuite() {
    ...
    try {
        ...
        if (initRes.isError)
            throw new Error("Initial screenshot failed: " + JSON.stringify(initRes));
        const initScreenPath = initRes.details?.imagePath;
